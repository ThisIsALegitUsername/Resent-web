...
![eaglercraft](https://media.discordapp.net/attachments/1043351454078992505/1043716142776201226/image.png?width=769&height=432)

## Features

* Savable mod status and positions
* 90+ Texture packs
* Custom hotkeys
* Movable mods
* ArmorHud
...
The stable build crash less often, and all features should work as intended. The dev build will have beta features, but may crash at times. The FPS build is an alternative with less mods, however has increased performance.
...
You can also give us your compiled texture packs in the discord server! 
