...
templatePatch("dawn_epk", dawnpit)    
templatePatch("007_epk", luvre)
templatePatch("1.17PvP_epk", 117pvp)
templatePatch("1.8_epk", 18)
...
templatePatch("simplebombies_epk", simplybombies)
